...
# Suppress the UserWarning related to keep_geom_type
...
def process_intersection_from_file(temp_path, parcelles_gdf):
    ...
    try:
        ...
        result = gpd.overlay(divided_roofs_chunk, parcelles_gdf, how='intersection')
...
if __name__ == "__main__":
    ...
    output_path = "/home/mahdi/interface/data/output/divide/roofs_divided_by_parcelles11.shp"
