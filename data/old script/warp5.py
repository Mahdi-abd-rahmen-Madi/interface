...
adjust_cmd = [
    "ogr2ogr",
    "roof_warped_adjusted_tps.shp",   # Output adjusted shapefile
    "roof_warped5_tps.shp",           # Input: TPS-transformed shapefile
    "-dialect", "Sqlite",
    "-sql", "SELECT ST_Translate(Geometry, 0.733, -5.179, 0 ) AS geometry, * FROM roof_warped5_tps"
]

print("Running translation adjustment...")
subprocess.run(adjust_cmd, check=True)
print("Translation adjustment complete.")